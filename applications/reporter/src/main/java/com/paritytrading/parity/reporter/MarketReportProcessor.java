...
class MarketReportProcessor implements PMRListener {
    ...
    public MarketReportProcessor(TradeListener listener) {
    ...
    public void trade(PMR.Trade message) {
        ...
        long buyOrderNumber = resting.side == PMR.BUY ? message.restingOrderNumber
                : message.incomingOrderNumber;
        long sellOrderNumber = resting.side == PMR.SELL ? message.restingOrderNumber
                : message.incomingOrderNumber;

        trade.timestamp       = message.timestamp;
        trade.matchNumber     = message.matchNumber;
        trade.instrument      = resting.instrument;
        trade.quantity        = message.quantity;
        trade.price           = resting.price;
        trade.buyer           = buy.username;
        trade.buyOrderNumber  = buyOrderNumber;
        trade.seller          = sell.username;
